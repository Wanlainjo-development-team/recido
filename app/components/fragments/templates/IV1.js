...
export const IV1 = (profile, invoiceId, date, invoiceContact, items, subTotal, vat, total, note, currentInvoiceId) => {
    const html = `
    ...
    <style>
        * {
        ...
        .invoice .row:nth-child(1) {
            border-bottom: 2px solid #${profile?.invoiceColor != undefined ? profile?.invoiceColor : '4169e1'}30;
        }
